...
private:
  ...
  **ActDisk_TempJump,  **ActDisk_Omega;      /*!< \brief Specified deltas for actuator disk.*/
  ...
  su2double *Surface_TotalPressure_Std;      /*!< \brief Total pressure at the boundaries. */ // GGPV
  su2double *Surface_UQ_number;              /*!< \brief Total pressure at the boundaries. */ // GGPV
...
void SetSurface_TotalPressure_Std(unsigned short val_marker, su2double val_surface_totalpressure) { Surface_TotalPressure_Std[val_marker] = val_surface_totalpressure; } // GGPV

void SetSurface_UQ_number(unsigned short val_marker, su2double val_surface_totalpressure) { Surface_UQ_number[val_marker] = val_surface_totalpressure; } // GGPV
  ...
  su2double GetSurface_TotalPressure_Std(unsigned short val_marker) const { return Surface_TotalPressure_Std[val_marker]; } // GGPV
  
  su2double GetSurface_UQ_number(unsigned short val_marker) const { return Surface_UQ_number[val_marker]; } // GGPV
