...
enum ENUM_OBJECTIVE {
  ...
  PRESSURE_DEVIATION = 66,      // GGPV
  UNCERTAINTY_QUANTIFICATION = 67,      // GGPV
};
static const MapType<std::string, ENUM_OBJECTIVE> Objective_Map = {
  ...
  MakePair("PRESSURE_DEVIATION", PRESSURE_DEVIATION) //GGPV
  MakePair("UNCERTAINTY_QUANTIFICATION", UNCERTAINTY_QUANTIFICATION) //GGPV
};
