...
///////////////////////////////////////// Aggiunto pezzo ////////////////////////////////////////
//if (config->GetKind_ObjFunc() == PRESSURE_DEVIATION) { // GGPV
   //AddHistoryOutput("PRESSURE_DEVIATION", "P_std", ScreenOutputFormat::FIXED, "P_STD", "Standart deviation of pressure distribution on surface", HistoryFieldType::COEFFICIENT);
  //}
...
/////////////////////////////////////// Aggiunto Pezzo ///////////////////////////////////////
  ...
  /*--- Set P_std fields ---*/
  // if (config->GetKind_ObjFunc() == PRESSURE_DEVIATION) {
    //Set_PressureSTD(flow_solver, geometry, config);  // GGPV
  //}
