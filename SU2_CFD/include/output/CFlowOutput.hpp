...
protected:
  ...
  /*!
   * \brief Set STD value of pressure on outlet section (and also into the solver).
   * \param[in,out] solver - The container holding all solution data.
   * \param[in] geometry - Geometrical definition of the problem.
   * \param[in] config - Definition of the particular problem.
   */
//////////////////////////////////// Aggiunto Pezzo //////////////////////////////////////////
  // void Set_PressureSTD(CSolver* solver, const CGeometry* geometry, const CConfig* config); //GGPV
////////////////////////////////////////////////////////////////////////////////////////////// 
  /*!
