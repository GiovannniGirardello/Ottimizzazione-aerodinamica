...
def get_objectiveSign( ObjFun_name ): #GGPV
    ...
    if ObjFun_name == "PRESSURE_DEVIATION"      : return -1.0 #GGPV
    if ObjFun_name == "UNCERTAINTY_QUANTIFICATION"      : return -1.0 #GGPV
...
def get_adjointSuffix(objective_function=None):
    ...
    name_map = { "DRAG"                        : "cd"        ,
                 ...
                 "PRESSURE_DEVIATION"          : "p_std"     , #GGPV
                 "UNCERTAINTY_QUANTIFICATION"  : "uq"        , #GGPV
                 "COMBO"                       : "combo"}
